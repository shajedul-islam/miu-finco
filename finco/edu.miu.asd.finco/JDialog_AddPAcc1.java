...
public class JDialog_AddPAcc1 extends javax.swing.JDialog
{
	...
	public JDialog_AddPAcc1(FincoFrm parent)
	{
		super(parent);
		parentframe=parent;
	...
	void JButtonOK_actionPerformed(java.awt.event.ActionEvent event)
	{
	  ...
	  // parentframe.newaccount=true;
       //dispose();
		...
		Customer customer = new ConcretePerson(JTextField_NAME.getText(),
				                ...
				                "", 
				                null);
		customer.AddAccount(new ConcreteAccount(JTextField_ACNR.getText(),
				parentframe.accountType,"P"
				));
